...
<div class="form-container">
    ...
    <form method="POST" action="add_user.php">
        ...
        <input type="number" name="purchase_frequency" step="1" min="0">

        <label for="avg_order_value">Average Order Value:</label>
        <input type="number" name="avg_order_value" step="0.01" min="0">

        <label for="loyalty_points">Loyalty Points:</label>
        <input type="number" name="loyalty_points" step="1" min="0">
